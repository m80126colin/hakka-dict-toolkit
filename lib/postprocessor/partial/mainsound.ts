...
const postprocessor = (sound : HakkaDictProtoType.MainSound, index : number, options : HakkaDictionaryToolkit.Option) : HakkaDictProtoType.MainSound | HakkaDictEntry.MainSound => {
  if (!options.verbose)
    return sound
  const s = {
